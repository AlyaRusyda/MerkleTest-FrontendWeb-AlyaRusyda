...
function App() {
  ...
  return (
    <div className="container p-2 mx-auto sm:p-4 text-gray-800">
      <h2 className="mb-4 text-2xl font-semibold text-center">User List</h2>
              ...
              {users.map((user) => (
                ...
                >
                  ...
                  <td className="p-3">
                    ...
                    <button
                      className="px-7 py-3 font-semibold rounded bg-red-600 hover:bg-red-700 text-gray-100 ml-4"
        ...
        {showModal && (
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white p-4 md:rounded-md">
              ...
              <div className="mt-4">
                <button
                  className="bg-red-500 hover:bg-red-700 text-white py-2 px-4 mr-2 rounded-md"
